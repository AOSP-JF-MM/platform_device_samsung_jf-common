...
def FullOTA_InstallEnd(info):
  ...
  info.script.AppendExtra('ifelse(is_substring("I545", getprop("ro.bootloader")), run_program("/sbin/sh", "-c", "busybox sed -i \'/rild.libpath/ r system/blobs/vzw/vzw.txt\' /system/build.prop"));')
  ...
  info.script.AppendExtra('ifelse(is_substring("L720", getprop("ro.bootloader")), run_program("/sbin/sh", "-c", "busybox sed -i \'/rild.libpath/ r system/blobs/cdma/cdma.txt\' /system/build.prop"));')
  ...
  info.script.AppendExtra('ifelse(is_substring("M919", getprop("ro.bootloader")), run_program("/sbin/sh", "-c", "busybox sed -i \'/rild.libpath/ r system/blobs/gsm/gsm.txt\' /system/build.prop"));')
  ...
  info.script.AppendExtra('ifelse(is_substring("R970", getprop("ro.bootloader")), run_program("/sbin/sh", "-c", "busybox sed -i \'/rild.libpath/ r system/blobs/usc/usc.txt\' /system/build.prop"));')
  ...
  info.script.AppendExtra('ifelse(is_substring("I9505", getprop("ro.bootloader")), run_program("/sbin/sh", "-c", "busybox sed -i \'/rild.libpath/ r system/blobs/gsm/gsm.txt\' /system/build.prop"));')
  ...
  info.script.AppendExtra('ifelse(is_substring("I9507", getprop("ro.bootloader")), run_program("/sbin/sh", "-c", "busybox sed -i \'/rild.libpath/ r system/blobs/gsm/gsm.txt\' /system/build.prop"));')
  ...
  info.script.AppendExtra('ifelse(is_substring("I9508", getprop("ro.bootloader")), run_program("/sbin/sh", "-c", "busybox sed -i \'/rild.libpath/ r system/blobs/gsm/gsm.txt\' /system/build.prop"));')
